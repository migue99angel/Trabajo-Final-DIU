...
Considero que este trabajo, y en general la asignatura nos ha servido para que nos fijemos en detalles que tenemos que tener en cuenta a la hora de desarrollar cualquier interfaz de usuario, por qué poner el botón ahí y no en otro sitio, o por qué utilizar una gama cromática en lugar de otra. Son detalles en los que usualmente no nos centramos cuando estamos programando el front-end de nuestro sitio web y al fin y al cabo son los detalles que hacen que una persona tenga una buena experiencia en la navegación y por tanto vuelva en un futuro.
